...
public class IndicatingAjaxButtonWrapper extends BaseWrapper{
	
	private static final long serialVersionUID = 1L;

	private static class EasyIndicatingAjaxButton extends IndicatingAjaxButton implements IEventSource{
		private static final long serialVersionUID = 1L;
		...
		public EasyIndicatingAjaxButton(String id, EasyWicket annot) {
			super(id);
			this.annot = annot;
	...
	protected Component createInstance(String widgetId, Class<? extends Component> widgetClass, EasyWicket annot,
		...
		return new EasyIndicatingAjaxButton(widgetId, annot);
	}
}
