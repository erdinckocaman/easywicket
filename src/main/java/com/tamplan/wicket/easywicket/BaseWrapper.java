...
public abstract class BaseWrapper implements IEasyWicketWrapper, Serializable {
	...
	public final Component create(String widgetId,
			Class<? extends Component> widgetClass, EasyWicket annot, MarkupContainer parentWidget) {
	...
	protected abstract Component createInstance(String widgetId, 
			Class<? extends Component> widgetClass, EasyWicket annot, MarkupContainer parentWidget);
