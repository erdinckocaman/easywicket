...
public class WebProjectTemplate1RequestCycle implements IRequestCycleListener {
	...
	public void onExceptionRequestHandlerResolved(RequestCycle requestCycle,
			IRequestHandler requestHandler, Exception exception) {
	}
	...
	public void onRequestHandlerScheduled(RequestCycle requestCycle,
