...
import net.sourceforge.easywicket.web.event.FormAfterProcessEvent;
import net.sourceforge.easywicket.web.event.FormBeforeProcessEvent;
import net.sourceforge.easywicket.web.event.FormOnValidateEvent;
...
public class FormWrapper implements IEasyWicketWrapper {
	...
	public Component create(String widgetId,
